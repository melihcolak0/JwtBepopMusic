...
{
    public class _Last5SongsDefaultComponent : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _Last5SongsDefaultComponent(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var response = await client.GetAsync("https://localhost:7157/api/Song/GetListLast5Songs/" + userPackageId);
